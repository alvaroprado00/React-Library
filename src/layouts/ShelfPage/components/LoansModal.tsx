                            ...
                            <div className="mt-3">
                                    ...
                                    <div className="col-2">
                                        {
                                            props.shelfCurrentLoan.book.img ?
                                                ...
                                                <img src={props.shelfCurrentLoan.book.img} height='87' width='56' alt="Book" />
                                                :
                                                <img src={require('../../../Images/BooksImages/book-luv2code-1000.png')} height='56' width='87' alt="Book" />
                                        }
                                ...
                                <div className="list-group mt-3">
                                    <button data-bs-dismiss='modal' className="list-group-item list-group-item-action"
                                        aria-current='true' onClick={()=>props.returnBook(props.shelfCurrentLoan.book.id)}>
                                        Return Book
                                    </button>
                                    <button           onClick={
                                            props.shelfCurrentLoan.daysLeft<0 ?
